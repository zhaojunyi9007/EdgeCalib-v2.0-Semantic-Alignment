...
def main():
    ...
    parser.add_argument("--img_dir", type=str, required=True, help="Directory containing images (png/jpg)")
    parser.add_argument("--out_dir", type=str, required=True, help="Directory to save masks and line features")
    parser.add_argument("--checkpoint", type=str, required=True, help="Path to SAM checkpoint (e.g., sam_vit_h_4b8939.pth)")
    ...
    for img_file in selected_files:
        ...
        extractor.process_image(full_path, args.out_dir)

...
# SAM处理帧范围（可自行调整）
export SAM_FRAME_START="0000000000"
export SAM_FRAME_END="0000000010"

# LiDAR处理帧范围（使用SAM配置，可单独覆盖）
export LIDAR_FRAME_START="${SAM_FRAME_START}"
export LIDAR_FRAME_END="${SAM_FRAME_END}"
...
# 子目录划分（分别保存不同脚本的结果）
export SAM_DIR="${RESULT_DIR}/sam"
export LIDAR_DIR="${RESULT_DIR}/lidar"
export OPTI_DIR="${RESULT_DIR}/opti"

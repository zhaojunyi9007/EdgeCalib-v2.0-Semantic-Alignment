...
echo "======================================"
echo ""
echo "All results are saved in the 'result' directory:"
echo "  - Feature files: result/*_points.txt, result/*_lines_3d.txt"
echo "  - Mask images: result/*_mask_ids.png"
echo "  - Calibration results: result/*_calib_result.txt"
echo "  - Visualization: result/visual_*.png"
echo ""
echo "Check the result directory for all output files."
